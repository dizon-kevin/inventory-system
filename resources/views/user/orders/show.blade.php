    ...
    <div class="wrap">
        ...
        <div class="grid">
                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <div class="detail-grid">
                            ...
                            <div class="detail"><label>Payment Link</label><div>@if($order->xendit_invoice_url)<a href="{{ $order->xendit_invoice_url }}" target="_blank" rel="noopener">Open Xendit payment page</a>@else Not available @endif</div></div>
                        </div>
                    </div>
                </section>
            ...
            <aside class="card sidebar-card">
                ...
                <div class="card-body">
                    <div class="detail" style="margin-bottom:.8rem;"><label>Status</label><div>{{ ucfirst($order->status) }}</div></div>
                    ...
                    <div class="actions" style="margin-top:1rem;">
                        ...
                        @if($order->xendit_invoice_url && $order->payment_status !== 'paid')
                            <a href="{{ $order->xendit_invoice_url }}" target="_blank" rel="noopener" class="btn btn-secondary">Continue Payment</a>
                        @endif
