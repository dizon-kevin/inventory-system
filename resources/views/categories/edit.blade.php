...
<head>
    ...
    <title>Edit Category — Storix</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .edit-wrap { width: 100%; max-width: 520px; }
        ...
        .preview-name  { font-size: .95rem; font-weight: 700; color: var(--tp); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        .preview-meta  { font-size: .72rem; color: var(--tm); margin-top: 3px; }
        ...
        .field-input {
            ...
            border-radius: 9px; color: var(--tp);
        ...
        .field-input:hover:not(:focus) { border-color: rgba(12,26,20,.14); }
        .field-input:-webkit-autofill { -webkit-box-shadow: 0 0 0 100px #f2f5f3 inset !important; -webkit-text-fill-color: #0c1a14 !important; }

        .field-hint { font-size: .74rem; color: var(--tm); line-height: 1.4; }

        .field-error { font-size: .74rem; color: #dc2626; display: flex; align-items: center; gap: 4px; }
            ...
            <div class="edit-wrap">
                ...
                <div class="preview-card">
                    ...
                    <div class="preview-info">
                        <p class="preview-name" id="previewName">{{ $category->name }}</p>
                        <p class="preview-meta">ID #{{ $category->id }} &middot; Created {{ $category->created_at->format('M d, Y') }}</p>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                        ...
                        <div class="form-body">
                            <div class="field">
                                ...
                                @else
                                    <p class="field-hint">This name will be visible to customers when browsing products.</p>
                                @enderror
                            </div>
                        </div>
...
<script>
    ...
    // Live preview: update category name in the preview card as user types
